<template>
    <div class='flex justify-center w-full'>
        ...
        <div v-else class="">
            <ul>
                <li v-for="(following, index) in followings" :key="following.id" class="">
                    <div class="p-2 bg-neutral-400 rounded-xl inline-flex items-center w-full justify-between">
                        ...
                        <div ref="checkDropdown" class="relative dropdown flex-inline">
                            ...
                            <div v-if="following.showOptions" class="absolute bg-cyan-600 shadow-lg rounded-b-xl p-2 z-10 w-full">
                                <button @click="cancelFollowing(following.id)" class="flex items-center rounded-full text-red-400 p-2 hover:bg-cyan-700 hover:scale-95 transition-transform duration-300 ease-in-out w-full">
                                ...
                                <button @click="blockUser(following.id)" class="flex items-center rounded-full text-red-400 p-2 hover:bg-cyan-700 hover:scale-95 transition-transform duration-300 ease-in-out w-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
