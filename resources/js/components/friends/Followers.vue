<template>
    <div class='flex justify-center w-full'>
        ...
        <div v-else class="">
            <ul>
                <li v-for="(follower, index) in followers" :key="followers.id" class="">
                    <div class="p-2 bg-neutral-400 rounded-xl inline-flex items-center w-full justify-between">
                        ...
                        <div ref="checkDropdown" class="relative dropdown flex-inline">
                            <div class="flex items-center shadow-lg rounded-xl bg-cyan-600 text-white p-1 mainButton w-48 justify-between">
                                ...
                                <button type='button' @click="toggleDropdown(index)" class="dropdownActions hover:scale-90 transition-transform">
                            ...
                            <div v-if="follower.showOptions" class="absolute bg-cyan-600 shadow-lg rounded-b-xl p-2 z-10 w-full">
                                <button @click="addFriend(follower.id)" class="flex items-center rounded-full text-green-400 p-2 hover:bg-cyan-700 hover:scale-95 transition-transform duration-300 ease-in-out w-full">
                                ...
                                <button @click="blockUser(follower.id)" class="flex items-center rounded-full text-red-400 p-2 hover:bg-cyan-700 hover:scale-95 transition-transform duration-300 ease-in-out w-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
